...
function renderClassifierDecision(
  ...
  const lines = [
    ...
    `automation_confidence=${classifier.automation_confidence}`,
    `automation_pattern=${classifier.automation_pattern} scope=${classifier.automation_scope}`,
    ...
    [
      ...
      trace.response_classifier
        ? [
            ...
            `automation_confidence=${trace.response_classifier.automation_confidence}`,
            `automation_pattern=${trace.response_classifier.automation_pattern}`,
            `automation_scope=${trace.response_classifier.automation_scope}`,
