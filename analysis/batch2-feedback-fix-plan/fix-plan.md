...
- Milestone 5 is complete for E1/E2 and tested: FAQ/scope prompts now clarify that the assistant does not design/build external websites, support fallback uses web chat or `hola@sinenvolturas.com`, gift/product claim answers are instructed to combine KB facts about no-obligation gifts, configured commission/value, direct brand claims, and Sin Envolturas help channels, and live eval cases cover both final FAQ scenarios.
